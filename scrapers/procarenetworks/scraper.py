...
def scrape(name):
    ...
    for suburb in suburbs:
        ...
        for practice in response:
            ...
            scraper.practice['address'] = practice['Address1_Line1'] + ", " + ((practice['Address1_Line2'] + ", ") if practice['Address1_Line2'] else "") + practice['Address1_Line3'] + ", " + practice['Address1_City']
