...
RUN apt-get install postgresql-9.6-postgis-2.3-scripts postgresql-contrib-9.6 postgresql-9.6-postgis-scripts python-psycopg2 libmemcached-dev zlib1g-dev -y && apt-get clean
