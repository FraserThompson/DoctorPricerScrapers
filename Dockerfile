...
RUN apt-get install postgresql-13-postgis-3 postgresql-contrib-13 postgresql-13-postgis-3-scripts python3-psycopg2 libmemcached-dev zlib1g-dev -y && apt-get clean
